...
function createSound2(){
			...
			theGear = new BABYLON.Sound("theSounds3", "sound/gears_new2.mp3", myScene, soundReady2, { loop: false, autoplay: false, volume: 0.5  });
			keyHelp = new BABYLON.Sound("theSounds3", "sound/key_help.mp3", myScene, soundReady2, { loop: false, autoplay: false, volume: 0.5  });
