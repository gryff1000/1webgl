...
// Keys code===================================================================================================	
	...
	// show menu tab 5 if you have all the keys					
					...
					levers.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function (evt) {
						...
						document.getElementById("words").style.display = "block";
						console.log("Levers clicked Keys = " + numKeys);
						if(numKeys === 4){
							items[5].isPickable = true;
							items[5].setVerticesData(BABYLON.VertexBuffer.UVKind, uvArray[5]);
					...
					items[0].actionManager = new BABYLON.ActionManager(myScene);
					items[0].actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function (evt) {
						//console.log("Book clicked");
						divWords.innerHTML = "I have Merlin's Magic Book - Morgana will be pleased";
						document.getElementById("words").style.display = "block";
						const myTimeout = setTimeout(clearInfo, 5000);
