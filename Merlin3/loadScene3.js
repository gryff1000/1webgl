function loadScene3(){
		...
		BABYLON.SceneLoader.Append("", "scene03/boat01c.babylon", myScene);
			...
			*/	
			...
			// use Mix Material to texture the island		
					...
					var myBoat = myScene.getMeshByName("boat");
					console.log(myBoat.position);
					//var myCube = myScene.getMeshByName("Cube");
					//console.log(myCube.position);
			...
			// load sound for scene 1		
					...
					theMagic1.onended = function(){
						sceneNum = sceneNum + 1;
						//let animation = myScene.beginAnimation(mySkeleton,1,69,true, 1);
